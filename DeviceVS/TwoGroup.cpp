...
void TwoGroup::updateInfo()
{
  ...
  //------------------Абонент 1--------------------------------------------------
    ...
    if (m_pDev->m_reg[10] & 2)
        m_pDev->ui.label_24->setText("Поддежка связи, Да");
    else
        m_pDev->ui.label_24->setText("Поддежка связи, Нет");
    //=============================================================================	
    //------------------Абонент 2--------------------------------------------------
    ...
    if (m_pDev->m_reg[13] & 2)
        m_pDev->ui.label_33->setText("Поддежка связи, Да");
    else
        m_pDev->ui.label_33->setText("Поддежка связи, Нет");
    //=============================================================================
    ...
    if (m_pDev->m_reg[16] & 2)
        m_pDev->ui.label_42->setText("Поддежка связи, Да");
    else
        m_pDev->ui.label_42->setText("Поддежка связи, Нет");
    //=============================================================================
    ...
    if (m_pDev->m_reg[19] & 2)
        m_pDev->ui.label_51->setText("Поддежка связи, Да");
    else
        m_pDev->ui.label_51->setText("Поддежка связи, Нет");
    //=============================================================================
}
